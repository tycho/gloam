 ...
 *
 *   gloam --api vk=1.3 --extensions VK_KHR_surface,VK_KHR_swapchain,VK_KHR_get_physical_device_properties2,VK_KHR_portability_enumeration --out-path examples/c/vk-cube/gloam c --loader
 *
 * Extensions: 4 explicit (4 included)
 *
