/*
 * @generated by gloam 0.5.2-15-gdd862ca.
 *
...
typedef struct GloamVulkanContext {
    ...
    union {
        unsigned char extArray[6];
        struct {
        /*    0 */ unsigned char EXT_debug_utils;
        /*    1 */ unsigned char KHR_get_physical_device_properties2;
        /*    2 */ unsigned char KHR_surface;
        /*    3 */ unsigned char KHR_swapchain;
        /*    4 */ unsigned char KHR_synchronization2;
        /*    5 */ unsigned char KHR_timeline_semaphore;
        };
    };
