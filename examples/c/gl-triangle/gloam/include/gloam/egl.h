...
typedef struct GloamEGLContext {
    ...
    union {
        ...
        struct {
        /*    0 */ unsigned char ANGLE_platform_angle;
        /*    1 */ unsigned char ANGLE_platform_angle_d3d;
        /*    2 */ unsigned char ANGLE_platform_angle_metal;
        /*    3 */ unsigned char ANGLE_platform_angle_opengl;
        /*    4 */ unsigned char ANGLE_platform_angle_vulkan;
        };
    };
