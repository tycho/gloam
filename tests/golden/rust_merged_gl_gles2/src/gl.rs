...
pub type GLGETBLOBPROCANGLE = Option<unsafe extern "system" fn(*const c_void, GLsizeiptr, *mut c_void, GLsizeiptr, *const c_void) -> GLsizeiptr>;
pub type GLSETBLOBPROCANGLE = Option<unsafe extern "system" fn(*const c_void, GLsizeiptr, *const c_void, GLsizeiptr, *const c_void)>;
...
static FN_NAME_OFFSETS: [u16; COMMAND_COUNT] = [
       ...
       6551, // [365] glDebugMessageControl
       6573, // [366] glDebugMessageInsert
       6594, // [367] glGetDebugMessageLog
       6615, // [368] glGetObjectLabel
       6632, // [369] glGetObjectPtrLabel
       6652, // [370] glObjectLabel
       6666, // [371] glObjectPtrLabel
       6683, // [372] glPopDebugGroup
       6699, // [373] glPushDebugGroup
       6716, // [374] glDebugMessageCallbackKHR
       6742, // [375] glDebugMessageControlKHR
       6767, // [376] glDebugMessageInsertKHR
       6791, // [377] glGetDebugMessageLogKHR
       6815, // [378] glGetObjectLabelKHR
       6835, // [379] glGetObjectPtrLabelKHR
       6858, // [380] glGetPointervKHR
       6875, // [381] glObjectLabelKHR
       6892, // [382] glObjectPtrLabelKHR
       6912, // [383] glPopDebugGroupKHR
...
#[rustfmt::skip]
static EXT_RANGES_gl: [(u16, u16, u16); 1] = [
    (   0,  363,   11), // GL_KHR_debug
];

#[rustfmt::skip]
static EXT_RANGES_gles2: [(u16, u16, u16); 1] = [
...
// extArray indices this API supports.
#[rustfmt::skip]
static EXT_IDX_gl: [u16; 1] = [
       0, // GL_KHR_debug
];

// extArray indices this API supports.
#[rustfmt::skip]
static EXT_IDX_gles2: [u16; 1] = [
       0, // GL_KHR_debug
];
...
static ALIAS_PAIRS: [(u16, u16); 11] = [
    ( 363,  380), // glGetPointerv <-> glGetPointervKHR
    ( 364,  374), // glDebugMessageCallback <-> glDebugMessageCallbackKHR
    ( 365,  375), // glDebugMessageControl <-> glDebugMessageControlKHR
    ( 366,  376), // glDebugMessageInsert <-> glDebugMessageInsertKHR
    ( 367,  377), // glGetDebugMessageLog <-> glGetDebugMessageLogKHR
    ( 368,  378), // glGetObjectLabel <-> glGetObjectLabelKHR
    ( 369,  379), // glGetObjectPtrLabel <-> glGetObjectPtrLabelKHR
    ( 370,  381), // glObjectLabel <-> glObjectLabelKHR
    ( 371,  382), // glObjectPtrLabel <-> glObjectPtrLabelKHR
    ( 372,  383), // glPopDebugGroup <-> glPopDebugGroupKHR
    ( 373,  384), // glPushDebugGroup <-> glPushDebugGroupKHR
];
...
impl Gl {
    ...
    unsafe fn load_gl_dyn(
        ...
        unsafe { gl.detect_extensions(&EXT_IDX_gl) };
    ...
    unsafe fn load_gles2_dyn(
        ...
        unsafe { gl.detect_extensions(&EXT_IDX_gles2) };
    ...
    unsafe fn detect_extensions(&mut self, subset: &[u16]) {
        if self.pfns[28].is_null() || self.pfns[263].is_null() {
            return;
        }
        let mut seen = [false; EXT_COUNT];
        let mut n: GLint = 0;
        ...
        while (i as GLint) < n {
            ...
            if !name.is_null() {
                ...
                if let Ok(pos) = EXT_HASH_KEYS.binary_search(&h) {
                    seen[EXT_HASH_IDX[pos] as usize] = true;
                }
            }
            i += 1;
        }
        // Only this API's subset: the extension flags an API never
        // declared stay false even if the driver advertises the name.
        for &idx in subset {
            self.ext[idx as usize] = seen[idx as usize];
        }
    }
...
pub fn global() -> &'static Gl {
    ...
    // forbids running while this reference (or any use of it) lives.
    unsafe { &*GLOBAL.0.get() }
}
