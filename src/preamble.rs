...
pub fn build_preamble(
    ...
    // ---- footer ----
    lines.push(" *".to_string());
    lines.push(" * DO NOT EDIT. This file is generated by gloam and will be overwritten;".to_string());
...
mod tests {
    ...
    fn preamble_copyright_groups_are_ordered_and_deduped() {
        ...
        let p = preamble_no_pins(&fs, "gloam --api gles2 c");
        assert_eq!(p.matches("The Khronos Group Inc.").count(), 1, "Khronos collapses");
        let apache = p.find("Apache-2.0").unwrap();
        let bsd2 = p.find("BSD-2-Clause").unwrap();
        let bsd3 = p.find("BSD-3-Clause").unwrap();
        assert!(apache < bsd2 && bsd2 < bsd3, "ordered Apache < BSD-2 < BSD-3");
    }
    ...
    fn preamble_has_do_not_edit_footer() {
        ...
        let generated_line = p.lines().position(|l| l.contains("Generated by gloam")).unwrap();
